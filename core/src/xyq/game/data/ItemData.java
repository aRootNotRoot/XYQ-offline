...
public class ItemData{
	...
	/**创建一个物品栏对象*/
	public ItemData(int itemType,int itemID){
	...
	public String getUseAnimateWas() {
		return useAnimateWas;
	}

	public void setUseAnimateWas(String useAnimateWas) {
		this.useAnimateWas = useAnimateWas;
	}
