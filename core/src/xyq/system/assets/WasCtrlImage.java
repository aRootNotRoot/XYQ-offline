...
public class WasCtrlImage implements Sprite {
	...
	public WasCtrlImage(ResSystem RS,String pack,String was,PPCData pp) {
		...
		*/
		beginIndex=0;
		endIndex=getLastIndex();
	}
	public int getLastIndex(){
		return frames.getFrames(currentDirect).length - 1;
	}
